...
def main_loop():
    # Pass in 0 to access the webcam instead of a video file.
    # If you get an error, the webcam probably isn't configured
    # in the VM.
    video_capture = cv2.VideoCapture("door.mp4", apiPreference = cv2.CAP_V4L2 )
    ...
    while True:
        ...
        for face_location, face_encoding in zip(face_locations, face_encodings):
            ...
            if metadata is not None:
                ...
                face_label = f"At door {int(time_at_door.total_seconds())}"
